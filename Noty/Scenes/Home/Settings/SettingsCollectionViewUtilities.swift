...
class SettingsCollectionViewUtilities: NSObject, SettingsCollectionViewUtilitiesProtocol {
    ...
    var shouldShowSongs: Bool = false
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        case 1: return 1
        case 2: return 1
        case 3: return optionsDataSource.count
        case 4: return 2
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 1:
            ...
            return cell
        case 2:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: R.reuseIdentifier.notifCell.identifier, for: indexPath) as? NotifCell else { return UICollectionViewCell() }
            return cell
        case 3:
            ...
            return cell
        case 4:
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: R.reuseIdentifier.configCell, for: indexPath) as? ConfigCell else { return UICollectionViewCell() }
            return cell
        default: assertionFailure()
        }
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader:
            ...
            case 2: sectionHeader.titleLabel.text = "Notification"
            case 3: sectionHeader.titleLabel.text = "Options"
            case 4: sectionHeader.titleLabel.text = "Account"
            default: break
            }
