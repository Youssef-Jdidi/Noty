...
struct R: Rswift.Validatable {
  ...
  struct nib {
    ...
    /// Nib `NotifCell`.
    static let notifCell = _R.nib._NotifCell()
    /// Nib `OptionCell`.
    ...
    /// Nib `SongCell`.
    static let songCell = _R.nib._SongCell()
    /// Nib `ThemeCell`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "NotifCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.notifCell) instead")
    static func notifCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.notifCell)
    }
    #endif
    ...
    #if os(iOS) || os(tvOS)
    /// `UINib(name: "SongCell", in: bundle)`
    @available(*, deprecated, message: "Use UINib(resource: R.nib.songCell) instead")
    static func songCell(_: Void = ()) -> UIKit.UINib {
      return UIKit.UINib(resource: R.nib.songCell)
    }
    #endif
    ...
    static func notifCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> NotifCell? {
      return R.nib.notifCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? NotifCell
    }
    ...
    static func songCell(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> SongCell? {
      return R.nib.songCell.instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? SongCell
    }
  ...
  struct reuseIdentifier {
    ...
    /// Reuse identifier `notifCell`.
    static let notifCell: Rswift.ReuseIdentifier<NotifCell> = Rswift.ReuseIdentifier(identifier: "notifCell")
    ...
    static let songCell: Rswift.ReuseIdentifier<SongCell> = Rswift.ReuseIdentifier(identifier: "songCell")
...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _NotifCell: Rswift.NibResourceType, Rswift.ReuseIdentifierType {
      typealias ReusableType = NotifCell

      let bundle = R.hostingBundle
      let identifier = "notifCell"
      let name = "NotifCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> NotifCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? NotifCell
      }
    ...
    struct _SongCell: Rswift.NibResourceType, Rswift.ReuseIdentifierType {
      typealias ReusableType = SongCell

      let bundle = R.hostingBundle
      let identifier = "songCell"
      let name = "SongCell"

      func firstView(owner ownerOrNil: AnyObject?, options optionsOrNil: [UINib.OptionsKey : Any]? = nil) -> SongCell? {
        return instantiate(withOwner: ownerOrNil, options: optionsOrNil)[0] as? SongCell
      }
